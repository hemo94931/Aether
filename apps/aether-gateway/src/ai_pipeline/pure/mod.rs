pub(crate) use aether_ai_pipeline::api::{
    ...
    api_format_alias_matches, apply_auto_reasoning_effort_from_model,
    ...
    auto_reasoning_effort_base_model, build_core_error_body_for_client_format,
    ...
    build_openai_responses_response, build_standard_request_body,
    ...
    normalize_auto_reasoning_effort_model, normalize_claude_request_to_openai_chat_request,
    ...
    split_auto_reasoning_effort_model, stream_body_contains_error_event,
    ...
    transform_provider_private_stream_line, value_as_u64, AutoReasoningEffortModel,
