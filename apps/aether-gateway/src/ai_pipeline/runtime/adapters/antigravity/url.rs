...
pub(crate) const ANTIGRAVITY_V1INTERNAL_PATH_TEMPLATE: &str = "/v1internal:{action}";

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) enum AntigravityRequestUrlAction {
    GenerateContent,
...
pub(crate) fn build_antigravity_v1internal_url(
    base_url: &str,
