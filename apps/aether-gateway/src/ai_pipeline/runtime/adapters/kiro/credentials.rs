...
pub(crate) const DEFAULT_KIRO_VERSION: &str = "0.8.0";
pub(crate) const DEFAULT_NODE_VERSION: &str = "22.21.1";
pub(crate) const DEFAULT_SYSTEM_VERSION: &str = "other#unknown";

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct KiroAuthConfig {
    pub(crate) auth_method: Option<String>,
    pub(crate) refresh_token: Option<String>,
    pub(crate) expires_at: Option<u64>,
    pub(crate) profile_arn: Option<String>,
    pub(crate) region: Option<String>,
    pub(crate) auth_region: Option<String>,
    pub(crate) api_region: Option<String>,
    pub(crate) client_id: Option<String>,
    pub(crate) client_secret: Option<String>,
    pub(crate) machine_id: Option<String>,
    pub(crate) kiro_version: Option<String>,
...
impl KiroAuthConfig {
    pub(crate) fn from_raw_json(raw: Option<&str>) -> Option<Self> {
        let raw = raw?.trim();
        if raw.is_empty() {
            return None;
        }
    ...
    pub(crate) fn from_json_value(raw: &Value) -> Option<Self> {
    ...
    pub(crate) fn effective_api_region(&self) -> &str {
        self.api_region
            .as_deref()
            .map(str::trim)
    ...
    pub(crate) fn effective_auth_region(&self) -> &str {
        self.auth_region
            .as_deref()
            .map(str::trim)
            .filter(|value| !value.is_empty())
    ...
    pub(crate) fn effective_kiro_version(&self) -> &str {
        self.kiro_version
            .as_deref()
            .map(str::trim)
            .filter(|value| !value.is_empty())
    ...
    pub(crate) fn effective_system_version(&self) -> &str {
        self.system_version
            .as_deref()
            .map(str::trim)
            .filter(|value| !value.is_empty())
    ...
    pub(crate) fn effective_node_version(&self) -> &str {
        self.node_version
            .as_deref()
            .map(str::trim)
            .filter(|value| !value.is_empty())
    ...
    pub(crate) fn cached_access_token(&self) -> Option<&str> {
        self.access_token
            .as_deref()
            .map(str::trim)
            .filter(|value| !value.is_empty())
    ...
    pub(crate) fn cached_access_token_requires_refresh(&self, skew_seconds: u64) -> bool {
    ...
    pub(crate) fn is_idc_auth(&self) -> bool {
    ...
    pub(crate) fn profile_arn_for_payload(&self) -> Option<&str> {
        if self.is_idc_auth() {
            return None;
        }
        self.profile_arn
    ...
    pub(crate) fn can_refresh_access_token(&self) -> bool {
...
pub(crate) fn normalize_machine_id(raw: &str) -> Option<String> {
    let raw = raw.trim();
    if raw.is_empty() {
        return None;
    }
...
pub(crate) fn generate_machine_id(
