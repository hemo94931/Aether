...
impl GatewayDataState {
    ...
    pub(in crate::gateway) async fn list_provider_catalog_providers_by_ids(
        &self,
        provider_ids: &[String],
    ...
    pub(in crate::gateway) async fn list_provider_catalog_providers(
        &self,
        active_only: bool,
    ) -> Result<Vec<StoredProviderCatalogProvider>, DataLayerError> {
        match &self.provider_catalog_reader {
    ...
    pub(in crate::gateway) async fn list_provider_catalog_endpoints_by_ids(
        &self,
        endpoint_ids: &[String],
    ...
    pub(in crate::gateway) async fn list_provider_catalog_endpoints_by_provider_ids(
        &self,
        provider_ids: &[String],
    ) -> Result<Vec<StoredProviderCatalogEndpoint>, DataLayerError> {
        match &self.provider_catalog_reader {
    ...
    pub(in crate::gateway) async fn list_provider_catalog_keys_by_ids(
        &self,
        key_ids: &[String],
    ...
    pub(in crate::gateway) async fn list_provider_catalog_keys_by_provider_ids(
        &self,
        provider_ids: &[String],
    ) -> Result<Vec<StoredProviderCatalogKey>, DataLayerError> {
        match &self.provider_catalog_reader {
    ...
    pub(in crate::gateway) async fn list_provider_catalog_key_page(
        &self,
    ...
    pub(in crate::gateway) async fn list_provider_catalog_key_stats_by_provider_ids(
        &self,
        provider_ids: &[String],
