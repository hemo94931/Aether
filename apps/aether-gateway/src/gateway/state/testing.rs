...
impl AppState {
    ...
    pub(crate) fn with_tunnel_identity_for_tests(
        ...
        self.tunnel = crate::gateway::tunnel::EmbeddedTunnelState::with_data_and_directory(
            Arc::clone(&self.data),
            crate::gateway::tunnel::TunnelAttachmentDirectory::for_tests(
                instance_id,
                relay_base_url,
                90,
            ),
    ...
    where
        I: IntoIterator<Item = crate::gateway::gateway_data::StoredUserSessionRecord>,
    {
        let store = self
            .auth_session_store
            .get_or_insert_with(|| Arc::new(StdMutex::new(HashMap::new())));
    ...
    where
        I: IntoIterator<Item = crate::gateway::AdminWalletPaymentOrderRecord>,
    {
        let store = self
    ...
    where
        I: IntoIterator<Item = crate::gateway::AdminWalletTransactionRecord>,
    {
        let store = self
    ...
    where
        I: IntoIterator<Item = crate::gateway::AdminWalletRefundRecord>,
    {
        let store = self
    ...
    where
        I: IntoIterator<Item = crate::gateway::AdminBillingRuleRecord>,
    {
        let store = self
    ...
    where
        I: IntoIterator<Item = crate::gateway::AdminBillingCollectorRecord>,
    {
        let store = self
