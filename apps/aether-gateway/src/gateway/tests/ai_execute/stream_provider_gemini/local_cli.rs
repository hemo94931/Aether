...
#[tokio::test]
async fn gateway_executes_gemini_cli_stream_via_local_decision_gate_without_python_decision_stream()
{
    #[derive(Debug, Clone)]
...
#[tokio::test]
async fn gateway_executes_vertex_ai_gemini_cli_stream_via_local_decision_gate_without_python_decision_stream(
) {
    #[derive(Debug, Clone)]
    struct SeenExecutionRuntimeStreamRequest {
        trace_id: String,
