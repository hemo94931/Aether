...
) -> crate::gateway::gateway_data::StoredUserSessionRecord {
    crate::gateway::gateway_data::StoredUserSessionRecord::new(
...
async fn start_auth_gateway_with_state(
    ...
    sessions: impl IntoIterator<Item = crate::gateway::gateway_data::StoredUserSessionRecord>,
) -> (
    String,
    Arc<Mutex<usize>>,
...
async fn start_auth_gateway_with_preferences_state(
    ...
    wallet: StoredWalletSnapshot,
    sessions: impl IntoIterator<Item = crate::gateway::gateway_data::StoredUserSessionRecord>,
    preferences: impl IntoIterator<Item = crate::gateway::gateway_data::StoredUserPreferenceRecord>,
) -> (
    String,
    Arc<Mutex<usize>>,
    tokio::task::JoinHandle<()>,
...
async fn gateway_handles_users_me_preferences_locally_without_proxying_upstream() {
    ...
    let (gateway_url, upstream_hits, gateway_handle, upstream_handle) =
        start_auth_gateway_with_preferences_state(
            ...
            std::iter::empty::<crate::gateway::gateway_data::StoredUserPreferenceRecord>(),
        )
        .await;
